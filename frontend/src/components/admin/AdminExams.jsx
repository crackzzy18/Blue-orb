...
const AdminExams = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editing) {
        await put(`/admin/exams/${editing}`, formData, authHeader);
      } else {
        await post('/admin/exams', formData, authHeader);
      }

      setFormData({ title: '', description: '', subject: '', year: '', fileCID: '' });
      setEditing(null);
      await loadItems();
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await del(`/admin/exams/${id}`, authHeader);
      await loadItems();
    } catch (error) {
